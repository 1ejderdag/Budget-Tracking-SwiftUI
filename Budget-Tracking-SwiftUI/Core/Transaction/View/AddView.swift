                            ...
                            Button {
                                ...
                                VStack {
                                    Image(systemName: category.iconName)
                                        ...
                                        .font(.title)
                                        .clipShape(Circle())
                                        .background(Circle().fill(selectedCategoryEx == category ? Color(.blue) : Color(.gray)))
                            ...
                            Button {
                                ...
                                VStack {
                                    Image(systemName: category.iconName)
                                        ...
                                        .font(.title)
                                        .clipShape(Circle())
                                        .background(Circle().fill(selectedCategoryIn == category ? Color(.blue) : Color(.gray)))
                                        .foregroundStyle(Color(.white))
...
/*
 LazyVGrid(columns: gridColumns, spacing: 25) {
     if selectionPicker == .expense {
         ForEach(DefaultCategories().defaultExpenseCategories, id: \.self) { model in
             VStack {
                 ZStack {
                     Circle()
                         .fill()
